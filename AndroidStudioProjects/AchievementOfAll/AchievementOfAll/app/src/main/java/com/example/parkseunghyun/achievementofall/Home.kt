...
//        storiesAdapter = StoriesAdapter(this@Home, storiesModelArrayList!!)
//        recyclerView!!.adapter = storiesAdapter


        val viewPager = findViewById<ViewPager>(R.id.pager_container)
        val pAdapter = adapter.PagerAdapter(supportFragmentManager)
        ...
        circle_indicator.createDotPanel(3, R.drawable.indicator_dot_off, R.drawable.indicator_dot_on, 0)
